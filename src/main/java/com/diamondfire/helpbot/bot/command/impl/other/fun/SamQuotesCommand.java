...
public class SamQuotesCommand extends Command {
    ...
    public void run(CommandEvent event) {
        ...
        if (event.getArgument("action") == null) {
            ...
            event.getChannel().sendMessageEmbeds(builder.build()).addFiles(FileUpload.fromData(file, "quote.png")).queue();
            ...
            event.getChannel().sendMessageEmbeds(builder.build()).addFiles(FileUpload.fromData(samQuote,"quote.png")).queue();
